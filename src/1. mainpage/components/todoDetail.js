...
`
const TodoDetail = ({setDetailTodo}) => {
  return (
    <TodoDetailSection>
       <TodoDetailContainer>
          <ExitButton onClick={()=>{setDetailTodo(false);}}>X</ExitButton>

          <TodoDetailTitle placeholder='Enter Title' />
          <TodoDetailContent placeholder='Enter Content'/>
